...
import CityCountyData from "../Register/asset/CityCountyData.json";
...
const StoreCheck = () => {
  ...
  // -------- 表單營業日期變更開始 -------- //
  // 宣告營業日
  let [closeDay, setCloseDay] = useState(["1", "2", "3", "4", "5", "6", "7"]);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      formData.append(
        "openTime",
        openTime.openHour + `:` + openTime.openMinute + `:` + `00.000000`
      );
      formData.append(
        "closeTime",
        closeTime.closeHour + `:` + closeTime.closeMinute + `:` + `00.000000`
      );

      // let response = await axios.post(`${API_URL}/storeCheck/storeCheck`, member);
      let response = await axios.post(
        `${API_URL}/storeCheck/storeCheck`,
        formData
      );
            ...
            <div className="label-group d-flex text-start flex-column justify-content-evenly gy-2">
                ...
                <div className="col-lg-6 col-md-10 col-sm-10 col-10">
                  ...
                  <div className="form-floating mb-3">
                    <input
                      ...
                      required
                    />
                    <label htmlFor="name" className="floating-label text-grey">
                      請填入中文 / 英文姓名
                    </label>
                    {fieldErrors.name !== "" && (
                  ...
                  <div className="row">
                    ...
                    <div className="col-6 mb-3">
                      <label className="input-label-title text-green">
                        City
                      </label>
                      <select
                        className={`form-control custom-input ${
                      ...
                      {fieldErrors.city !== "" && (
                        <div className="error text-end">{fieldErrors.city}</div>
                      )}
                    </div>
                    ...
                    <div className="col-6 mb-3">
                      ...
                      {fieldErrors.area !== "" && (
                        <div className="error text-end">{fieldErrors.Area}</div>
                      )}
                    </div>
                    <div className="form-floating mb-3">
                      {/* 詳細地址 */}
                      ...
                      <label
                        htmlFor="address"
                        className="floating-label text-grey ms-3"
                      >
                        請輸入詳細地址
                      </label>
                      {fieldErrors.address !== "" && (
                  ...
                  <div className="form-floating mb-3">
                    ...
                    {fieldErrors.phone !== "" && (
                      <div className="error text-end">{fieldErrors.phone}</div>
                    )}
                  </div>
                  {/* -------- 使用者同意條款 -------- */}
                </div>
                ...
                <div className="col-lg-6 col-md-10 col-sm-10 col-10">
                  ...
                  <div className="form-floating mb-3">
                    <select
                      name="storeType"
                      className={`form-control custom-input ${
                        fieldErrors.storeType !== "" && "input-error"
                      }`}
                      id="storeType"
                      placeholder="商品類別"
                  ...
                  <div className="d-block mb-3 me-0 opendayCheck">
                    ...
                    <div className="row input-label-title text-green text-center mt-3 mb-3 ms-1 me-1">
                      <label htmlFor="mon" className="col">
                        一
                      </label>
                      <label htmlFor="tue" className="col">
                        二
                      </label>
                      <label htmlFor="wed" className="col">
                        三
                      </label>
                      <label htmlFor="thu" className="col">
                        四
                      </label>
                      <label htmlFor="fri" className="col">
                        五
                      </label>
                      <label htmlFor="sat" className="col">
                        六
                      </label>
                      <label htmlFor="sun" className="col">
                        七
                      </label>
                    </div>
                  </div>
              ...
              <p className=" input-label-title text-grey text-center m-0 mb-3">
                ...
                <Link to="/StoreLogin" className="no-link">
                  <span className=" text-yellow ms-2">立即登入</span>
                </Link>
              </p>
            </div>
          </div>
